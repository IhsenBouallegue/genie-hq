...
export const metadata: Metadata = {
  ...
  description: "Genie HQ Privacy Policy",
};
  ...
  return (
    <div className="w-full flex items-center justify-center">
      <div className="prose dark:prose-invert lg:prose-lg max-w-screen-lg py-24">
        ...
        <p>
          Welcome to GenieHQ ("we," "us," "our"). We are committed to protecting
          your personal data and your privacy rights. This Privacy Policy
        ...
        <ul>
          <li>
            To send newsletters, updates, and promotional materials related to
            our services.
          </li>
        ...
        <p>
          We process your data based on your consent, which you provide by
          opting in to receive our communications. You may withdraw your consent
          at any time by clicking the unsubscribe link in our emails or
        ...
        <p>
          ...
          However, we use the services of third-party providers like{" "}
          <Link
          ...
          to manage and send our email communications. These providers are
          contractually obligated to protect your data and use it only for the
          purpose of providing the specific service to us.
        </p>

        <h2>6. Data Retention</h2>
        <p>
          We retain your data only as long as necessary to fulfill the purposes
          for which it was collected, or as required by law. If you unsubscribe
          from our communications, your data will be promptly deleted.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Right to Rectification:</strong> correct any inaccuracies in
            your data.
          </li>
          <li>
          ...
          <li>
            <strong>Right to Restrict Processing:</strong> request a restriction
