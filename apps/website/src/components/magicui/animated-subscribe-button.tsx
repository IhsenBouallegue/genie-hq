      ...
      {status === "loading" && (
        ...
        >
          <motion.span
            ...
            animate={{
              x: [
                0, -0.3, 0.3, -0.6, 0.6, -0.9, 0.9, -1.2, 1.2, -1.5, 1.5, -1.8, 1.8, -2.1, 2.1,
                -2.4, 2.4, -2.7, 2.7, -3, 3, -3.3, 3.3, -3.6, 3.6, -3.9, 3.9, -4.2, 4.2, -4.5, 4.5,
                -4.8, 4.8, -5.1, 5.1, -5.4, 5.4, -5.7, 5.7, -6, 6, -6.3, 6.3, -6.6, 6.6, -6.9, 6.9,
                -7.2, 7.2, -7.5, 7.5, -7.8, 7.8, -8.1, 8.1, -8.4, 8.4, -8.7, 8.7, -9, 9, -9.3, 9.3,
                -9.6, 9.6, -9.9, 9.9, -10.2, 10.2, -10.5, 10.5,
              ],
              transition: {
                duration: 4.69,
