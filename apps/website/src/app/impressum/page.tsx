    ...
    <div className="w-full flex items-center justify-center">
      <div className="prose dark:prose-invert lg:prose-lg max-w-screen-lg py-24 px-6">
        ...
        <p>
          ...
          <br />
          Currently under development – address and registration details will be
          updated upon official business registration.
        </p>
        ...
        <p>
          ...
          responsible for our content on these web pages. In this context,
        ...
        <p>
          ...
          third parties) lies solely with the operators of the linked pages. At
          the time of linking, no violations were evident to us. Should any
        ...
        <p>
          ...
          copyright laws of [Country]. Duplication, processing, distribution, or
          any form of commercialization of such material beyond the scope of the
          copyright law requires the prior written consent of its respective
          author or creator.
        </p>
        ...
        <p>
          <strong>Note:</strong>
          <br />
          This imprint will be updated with additional details upon the official
